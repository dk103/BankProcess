...
#res = user_Details_services.login_details_Validation('mishra92@gmail.com','M1030513')
...
#   config_meta.updateAccountValue(resList[2])
  my_logger.info('---  cookie[accountId]--'+ str(cookie['accountId'].value))
