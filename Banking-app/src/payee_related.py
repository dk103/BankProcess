...
def formTableDataContent(res):
    ...
    for rowData in res:
        value = rowData.split("@")
        msg=msg+"<tr><td>"+value[0]+"</td>"+"<td>"+value[1]+"</td>"+"<td>"+value[2]+"</td>"+"<td>"+value[3]+"</td></tr>"
        value=None
    return msg
...
if(querytype=="add"):
    ...
    if(res == "Passed"):
      ...
      print ("Content-Type: text/html\r\n")
      print ("<h3><span style='color:green' class='glyphicon glyphicon-thumbs-up'></span> Payee removed Successfully.</h3><br>")
