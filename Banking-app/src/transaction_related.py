...
def formTableDataContent(res):
    ...
    for rowData in res:
        value = rowData.split("@")
        if(value[1]=="FUND TRANSFER"):
            msg=msg+"<tr style='color:red'><td>"+value[0]+"</td>"+"<td>"+value[1]+"</td>"+"<td>"+value[2]+"</td>"+"<td>"+value[3]+"</td>"+"<td>"+value[4]+"</td></tr>"
        else:
